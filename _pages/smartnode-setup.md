  ...
  <h2>To build your Smartnode, follow these simple steps</h2>
    ...
    <div>
      ...
      <h4>4. Configure Fail2Ban</h4>
            ...
            <div>
                 <p><b>wget https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/v3.1.1.5/yerbas-ubuntu20-v3.1.1.5.tar.gz<br/>
                     ...
                     cd .yerbascore<br/>
                     wget https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/v3.1.1.5/powcache.dat<br/>
                     cd ~/yerbas-build<br/>
                     ./yerbasd<br/></b> 
                  </p>
            </div>
